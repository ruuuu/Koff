...
export class Pagination {
      ...
      constructor(){
            if(!Pagination.instance){
                  ...
                  this.pagination = this.createPagination();   // верстка блока пагинации
      ...
      createPagination(){  // отрисоввка юлка пагинации

            const pagination = document.createElement('div');
            pagination.classList.add('pagination');

            this.paginationBar = document.createElement('div');  //у paginationBar есть this, чтобы можно  было обратиься  кнему из др метода
            ...
            this.paginationRight = document.createElement('a');   // ставим this  тк он управляемым будет
            ...
            this.currentPagination = document.createElement('span');   // ставим this  тк он управляемым будет
            this.currentPagination.classList.add('pagination__current');

            const paginationSeparator = document.createTextNode('из');  // создает элемент у которого нет тега

            this.totalPagination = document.createElement('span');
            this.totalPagination.classList.add('pagination__total');

            paginationInfo.append(this.currentPagination, paginationSeparator, this.totalPagination);
            ...
            //console.log('this in createPagination()', this)  // {paginationBar: div.pagination__bar, paginationLeft: a.pagination__left, paginationRight: a.pagination__right, currentPagination: span.pagination__current, totalPagination: span.pagination__total}
            return pagination;
      }
