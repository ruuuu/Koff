...
export class  ProductList {
      ...
      getHTMLTemplateListItem( {id, images: [image], price, name}){  // item = {}
           //console.log('item ', item);
            return  `
                  <article class="goods__card card">
                        <a class="card__link card__link--img" href="/product/${id}">
                              <img class="card__image" src="${API_URL}${image}" alt="${name}">
                        </a>

                        <div class="card__info">
                              <h3 class="card__title">
                                    <a class="card__link" href="/product/${id}"> ${name} </a>
                              </h3>
